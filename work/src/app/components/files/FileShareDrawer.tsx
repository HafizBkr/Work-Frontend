      ...
      <div className="p-8 flex-1 flex flex-col min-h-full max-w-lg w-full mx-auto relative">
        ...
        <div className="mb-6">
          <div className="flex gap-2">
            <input
              className="flex-1 text-black border border-black rounded-lg px-3 py-2 focus:outline-none "
              placeholder="Membres, groupes et externes..."
              type="text"
              // value, onChange à brancher selon logique réelle
            />
            <Button className="bg-blacktext-white px-4 py-2 rounded-lg font-semibold">
              Ajouter
            </Button>
          </div>
        </div>
