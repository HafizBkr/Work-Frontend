  ...
  return (
    <Drawer open={open} onClose={onClose} width={420}>
      ...
      >
        ...
        <input
          className="border rounded px-3 py-2 mb-4 text-black bg-gray-50 focus:outline-none focus:ring-2 "
        ...
        <input
          type="datetime-local"
          className="border rounded px-3 py-2 mb-6 text-black bg-gray-50 focus:outline-none focus:ring-2 "
