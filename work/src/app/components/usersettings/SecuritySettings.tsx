      ...
      <div className="mb-8">
        ...
        {sessions.filter((s) => !s.active).length > 0 && (
          <button
            ...
            className="w-full mt-2 px-4 py-3 text-base font-semibold text-white bg-purple-600 rounded-2xl hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition"
          >
